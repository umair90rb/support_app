...
class ChatScreenState extends State<ChatScreen> {
      ...
      return Row(
        children: <Widget>[
          ...
          // Sticker
              : Container(
            child: Image.asset(
              'images/${document.data()['message']}.gif',
              width: 100.0,
              height: 100.0,
              fit: BoxFit.cover,
            ),
  ...
  bool isLastMessageLeft(int index) {
    if ((index > 0 &&
        listMessage != null &&
        listMessage[index - 1].data()['sentFrom'] == id) ||
        index == 0) {
      return true;
    } else {
      return false;
  ...
  bool isLastMessageRight(int index) {
    if ((index > 0 &&
        listMessage != null &&
        listMessage[index - 1].data()['sendFrom'] != id) ||
        index == 0) {
      return true;
    } else {
      return false;
